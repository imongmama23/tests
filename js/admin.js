...
window.openAddonsModal = async function (bookingId) {
  ...
  const bookingFee = booking.cost?.bookingFee || 0;
  const remainingBalance = Math.max(0, totalAmount - bookingFee);

  const modal = `
        <div class="modal-overlay" onclick="modalSystem.close()" style="background:rgba(0,0,0,0.5);">
    ...
    <div class="modal-overlay" onclick="modalSystem.close()" style="background:rgba(0,0,0,0.5);">
      <div class="modal-content" onclick="event.stopPropagation()" 
        ...
        <div style="padding:1.75rem 2rem;border-bottom:1px solid #e5e7eb;">
          ...
          <button onclick="modalSystem.close()" style="position:absolute;top:1.5rem;right:2rem;background:transparent;border:none;font-size:2rem;color:#9ca3af;cursor:pointer;">×</button>
        </div>
        ...
        <div style="padding:1.5rem 2rem;border-top:1px solid #e5e7eb;display:flex;justify-content:flex-end;gap:0.75rem;">
          <button onclick="modalSystem.close()" style="padding:0.65rem 1.5rem;background:white;border:1px solid #d1d5db;border-radius:8px;font-weight:600;">Cancel</button>
